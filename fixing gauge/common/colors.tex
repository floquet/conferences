...
\definecolor{engilityblue}{rgb} {0.004, 0.332, 0.617}
\definecolor{engilityred} {rgb} {0.734, 0.125, 0.211}

%\definecolor{rangecolor} {blue}
%\definecolor{nullcolor}  {red}

%% basic color directives
\newcommand{ \eb }[1]        {{\color{engilityblue}  {#1}}}
\newcommand{ \er }[1]        {{\color{engilityred}   {#1}}}
